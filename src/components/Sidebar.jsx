...
const Sidebar = () => {
  ...
  return (
    <div className="w-16 md:w-60 pt-8 px-4 flex h-screen fixed flex-col bg-white">
      {/* logo */}
      <div className="mb-8">
      ...
      {/* Navigation Links */}
      <ul className="mt-6 space-y-6 flex-1 py-8 flex flex-col  gap-0.5">
      ...
      <p className="flex flex-col items-center space-x-2 text-xs text-white py-2 px-5 bg-gradient-to-r from-indigo-500 to-violet-600 rounded-full">
        {" "}
